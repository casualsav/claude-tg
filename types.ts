...
export type Access = {
  ...
  richMessages?: boolean  // outbound replies via Bot API 10.1 rich messages (native tables/headings/code); falls back to HTML on error (default ON — opt out with false)
